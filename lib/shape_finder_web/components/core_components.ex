defmodule ShapeFinderWeb.CoreComponents do
  @moduledoc """
  ...
  def input(assigns) do
    ...
    <div phx-feedback-for={@name}>
      ...
      <input
        ...
        class={[
          "mt-2 block w-full rounded-lg text-zinc-900 focus:ring-0 text-2xl sm:leading-6",
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ShapeFinderWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ShapeFinderWeb.Gettext, "errors", msg, opts)
    end
  end
