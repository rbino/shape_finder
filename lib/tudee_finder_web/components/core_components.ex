defmodule TudeeFinderWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TudeeFinderWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TudeeFinderWeb.Gettext, "errors", msg, opts)
    end
  end
