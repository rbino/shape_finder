defmodule TudeeFinderWeb.TudeeLive.TudeeComponent do
  use Phoenix.Component

  def tudee_svg(assigns) do
    ~H"""
    <svg class={[fill(@tudee.color)]} viewBox="0 0 220 220">
      <polygon points={polygon_points(110, 110, @tudee.sides, radius(@tudee.dimensions))} />
    </svg>
    """
  end
